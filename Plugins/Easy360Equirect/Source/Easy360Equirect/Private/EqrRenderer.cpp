...
void ConvertCubeToEquirect_RenderThread(FRHICommandListImmediate& RHICmdList,
    FTextureRHIRef InCubeRHI,FTextureRHIRef Out2DRHI,const FIntRect& ViewRect,const FMatrix44f& Rot,bool bApplySrgb)
{
  ...
  P->RotMat=Rot;
  P->MiscFlags=FVector4f(bApplySrgb?1.f:0.f,0.f,0.f,0.f);
