...
private:
    ...
    FReply OnStart(){
        ...
        A->bRecordSequence=ChkRecord->IsChecked();
        A->bRecordAudio=ChkAudio->IsChecked();
        A->bUseNvenc=ChkNvenc->IsChecked();
        A->bPipeEncode=ChkPipe->IsChecked();
        A->bShowPreviewScreen=ChkPreview->IsChecked();
